...
// toma la fecha y hora 
    ...
    public Boolean pago_server(Boolean input) throws java.rmi.RemoteException
    {
        System.out.println("Procesando pago con flag'" + input + "'");
        try {
            Thread.sleep(3000); // hilo actual
        ...
        if(input==false){
            ...
            System.out.println("Procesamiento de pago aceptado.");
            //System.out.println(input);
            return input;
        }
